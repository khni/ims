 ...
 */
export const baseMutateRegionSchema = regionSchema.omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
 ...
 */
export const createRegionRepoSchema =
  baseMutateRegionSchema;

export const updateRegionRepoSchema =
  baseMutateRegionSchema;
...
export const createRegionBodySchema =
  createRegionRepoSchema.omit({
    organizationId: true,
  });

export const updateRegionBodySchema =
  updateRegionRepoSchema.omit({
    organizationId: true,
  });
 ...
 */
export const mutateRegionResponseSchema =
  regionSchema.pick({
    id: true,
    name: true,
  });
 ...
 */
export const getRegionByIdResponseSchema =
  regionSchema.pick({
    id: true,
    name: true,
    updatedAt: true,
 ...
 * List response
 */
export const regionListResponseSchema =
  getRegionByIdResponseSchema.array();
...
/**
 * Unique identifier for fetching a single region
 * - Matches Prisma WhereUniqueInput
 * - Usually only "id", but can be extended (email, slug, etc.)
 */
export const RegionWhereUniqueInputSchema = z.object({
  id: z.string(),
});
 ...
 */
export const RegionRepoFiltersSchema = z.object({
  OR: z
    .array(
      z.union([
        z.object({ name: StringFilter }),
 ...
 */
export const RegionSortingSchema = z.object({
 ...
 */
export const RegionRepoSortingSchema = z.object({
